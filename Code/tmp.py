...
for lambda_val in lambda_opt :
    ...
    for j in range(N_test):
        ...
        BD_complet.loc[bat_index, 'ERR_LOGTS'] = np.abs(val_pred - val_reel) # ajout dans la couche
...
BD_complet.to_file("quimper_err_nb-logts.shp") # export SHP
